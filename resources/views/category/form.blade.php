            ...
            <div class="card-body px-0 pb-2">
                ...
                <!-- Name -->
                    <div style="display: block">
                        ...
                        <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="{{$users->name}}"
                                 required autofocus/>
                    </div>
                    ...
                    <div class="mt-4" style="display: block">
                        ...
                        <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="{{$users->email}}"
                                 required/>
                    </div>

                    <!-- Phone -->
                    <div class="mt-4" style="display: block">
                        <x-label for="phone" :value="{{$users->phone}}"/>
